  ...
  return (
    <MarketingPage title="Terms of use">
      ...
      <p>
        ...
        the time actually spent on a call, billed per second at the listener&apos;s advertised
        per-minute rate (rounded to the nearest penny), up to the length they authorise. Listeners
        receive 75% of the amount charged; gonatter retains a 25% platform fee. Payments are
        processed by Stripe.
      </p>
      <h2>Changes</h2>
